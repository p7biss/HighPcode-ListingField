...
public class OptionsGui extends JPanel {
	...
	public static final ScreenElement HIGHPCODE_LINE_LABEL = new ScreenElement("High P-code Line Label", HighPcodeColors.LABEL);
	public static final ScreenElement HIGHPCODE_ADDR_SPACE = new ScreenElement("High P-code Address Space", HighPcodeColors.ADDRESS_SPACE);
	public static final ScreenElement HIGHPCODE_RAW_VARNODE = new ScreenElement("High P-code Raw Varnode", HighPcodeColors.VARNODE);
	public static final ScreenElement HIGHPCODE_USEROP = new ScreenElement("High P-code Userop", HighPcodeColors.USEROP);
	...
	static ScreenElement[] elements =
		{ ADDRESS, BACKGROUND, BAD_REF_ADDR, BYTES, COMMENT_AUTO, COMMENT_EOL, COMMENT_PLATE,
			...
			FUN_RET_TYPE, FUN_TAG, HIGHPCODE_LINE_LABEL, HIGHPCODE_ADDR_SPACE, HIGHPCODE_RAW_VARNODE,
			HIGHPCODE_USEROP, LABELS_LOCAL, LABELS_NON_PRIMARY, LABELS_PRIMARY, LABELS_UNREFD,
