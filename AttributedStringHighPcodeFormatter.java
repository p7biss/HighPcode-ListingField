...
public class AttributedStringHighPcodeFormatter extends
	AbstractPcodeFormatter<List<AttributedString>, AttributedStringHighPcodeFormatter.ToAttributedStringsAppender> {
	...
	class ToAttributedStringsAppender extends AbstractAppender<List<AttributedString>> {
		...
		public void appendLineLabelRef(long label) {
			lineList.add(
				new AttributedString(stringifyLineLabel(label), HighPcodeColors.LABEL, metrics));
		}
		...
		public void appendUserop(int id) {
			lineList.add(
				new AttributedString(stringifyUserop(language, id), HighPcodeColors.USEROP, metrics));
		}
		...
		public void appendRawVarnode(AddressSpace space, long offset, long size) {
			lineList.add(new AttributedString(stringifyRawVarnode(space, offset, size),
				HighPcodeColors.VARNODE, metrics));
		}
		...
		public void appendSpace(AddressSpace space) {
			lineList.add(
				new AttributedString(stringifySpace(space), HighPcodeColors.ADDRESS_SPACE, metrics));
		}
