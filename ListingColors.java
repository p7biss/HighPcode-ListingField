...
public class ListingColors {
	...
	public static class HighPcodeColors {
		public static final GColor LABEL = new GColor("color.fg.listing.highpcode.label");
		public static final GColor ADDRESS_SPACE = new GColor("color.fg.listing.highpcode.address.space");
		public static final GColor VARNODE = new GColor("color.fg.listing.highpcode.varnode");
		public static final GColor USEROP = new GColor("color.fg.listing.highpcode.userop");
	}
